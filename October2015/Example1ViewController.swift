...
class Example1ViewController: UIViewController, RelativePositionViewDelegate {
  ...
  func nextButtonPressed(button:UIButton) {
    self.navigationController?.pushViewController(Example1aViewController(), animated: true)
  }
}
